...
| v0.52 TestFlight beta launch rehearsal | [#37](https://github.com/usefoil/foil-ios/pull/37), metadata fix [#47](https://github.com/usefoil/foil-ios/pull/47) | Historical board merged as blocked; #47 merged 2026-06-12 after fresh green CodeQL | Superseded for release gating by `ios-testflight-readiness-physical-gate`, which validates as done and proves build `0.1.0 (13)` validation/upload/processing/internal group plus preview-phone readiness smoke. |
